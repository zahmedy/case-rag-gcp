...
## Contributing
- Fork, branch, open PR with focused changes.
...
- Add role-based access and request quotas.
- Add automated ingestion pipeline (Cloud Functions / Pub/Sub) to process new uploads.
